...
<head>
  ...
  <title>All Records - CredentiaTAU</title>
...
<a href="<?= base_url('super-admin/all-records'); ?>" class="w-full flex items-center gap-3 px-4 py-3 text-green-700 bg-green-50 rounded-lg font-medium mb-2">
<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Main Content - Reuse Academic Records Layout -->
    ...
    <div class="flex items-center justify-end">
      <div class="flex items-center gap-3">
        <div class="text-right">
          <p class="text-sm font-semibold text-gray-800"><?= esc($email ?? 'Super Admin'); ?></p>
